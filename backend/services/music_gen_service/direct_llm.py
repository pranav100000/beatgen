...
#         get_instrument_metadata()
#         get_all_soundfonts()[:10]  # Limit to avoid context overload

#         system_prompt = """You are AutoCompose, an AI music composer.
...
#         logger.debug(
#             f"Generating MIDI for music description: {music_description.get('title', 'Untitled')}"
#         )
...
#                 raise ValueError(
#                     f"Missing required field in music description: {field}"
#                 )

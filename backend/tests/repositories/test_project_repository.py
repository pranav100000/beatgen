...
class TestProjectRepository:
    ...
    @pytest.mark.asyncio
    async def test_get_with_tracks(self, project_repository, sample_project_with_tracks):
    ...
    @pytest.mark.asyncio
    async def test_get_all_with_filter(self, project_repository, sample_project, db_session):
    ...
    @pytest.mark.asyncio
    async def test_get_by_user_id_with_tracks(self, project_repository, sample_project_with_tracks):
        """Test get_by_user_id_with_tracks"""
        # Act
        results = await project_repository.get_by_user_id_with_tracks(sample_project_with_tracks.user_id)

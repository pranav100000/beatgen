...
class DrumSamplePublicRepository:
    ...
    async def update(self, file_id: uuid.UUID, file_data: Dict[str, Any]) -> DrumSamplePublic:
        """
    ...
    async def create_upload_url(self, file_name: str, file_id: uuid.UUID) -> Dict[str, str]:
        """
        ...
        try:
            ...
            self.logger.info(f"Created upload URL for Drum Sample: {file_name} at path {storage_key}")
            return result
        except Exception as e:
